  ...
  return (
    <>
      <SEO title="ШВАРЦ ЧÖРНЫЙ — Поэзия • Музыка • Истории"
        description="Шварц Чорный — поэт, композитор и автор песен. Цифровой архив: стихи, музыка, истории и биография."
        ...
        jsonLd={{ '@context': 'https://schema.org', '@type': 'Person', name: 'Шварц Чорный',
          ...
          jobTitle: ['Поэт','Композитор','Автор песен'],
          description: 'Поэт, композитор и автор песен. Цифровой архив поэзии, музыки и историй.',
          url: 'https://shvarts.ru/', image: HERO_IMG }} />
