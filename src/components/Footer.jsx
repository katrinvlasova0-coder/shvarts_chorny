        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <ul className="space-y-2 font-ui text-sm text-[#A9A9A9]">
              {[['Поэзия','/poetry'],['Музыка','/music'],['Биография','/biography'],['Новости','/news'],['СМИ','/media'],['Контакт','/contact'],['Избранное','/favorites']].map(([l,t])=>(
                <li key={t}><Link to={t} className="hover:text-[#FDFCF8] transition-colors">{l}</Link></li>
              ))}
              <li><a href="/old/" className="hover:text-[#FDFCF8] transition-colors">Старая версия</a></li>
            </ul>
          </div>
          <div className="space-y-4">
            <ul className="space-y-2 font-ui text-sm text-[#A9A9A9]">
              <li><Link to="/contact" className="hover:text-[#FDFCF8] transition-colors">Написать</Link></li>
